...
Download Ravit from the App Store or Google Play. Open the app and sign in with your Ravelry account. Ravit connects directly to your existing Ravelry data — projects, stash, queue, favorites, and forum activity.
...
Your Ravelry stash is available in Ravit, including offline access. Check what you already own without a cell signal — useful at a yarn store. Ravit caches your stash data so you can search, sort, and view it offline.
