...
See [reading crochet patterns](https://docs.crochetly.com/reference/reading-crochet-patterns.md) for more information.

## Reading a yarn labels

See [reading yarn labels](https://docs.crochetly.com/reference/reading-yarn-labels.md) for more information.
