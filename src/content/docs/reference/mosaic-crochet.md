...
description: Learn mosaic crochet with this beginner-friendly guide covering overlay and inset techniques, basic stitches (sc, dc, blo), chart reading, and sample row instructions for one-color-per-row colorwork.
---
...
**Sources:** [Ravelry](https://www.ravelry.com/), mosaic crochet tutorials on YouTube

## What is Mosaic Crochet?

Mosaic crochet creates colorful motifs using simple stitches, including single crochet, double crochet, and chains, all worked one color at a time. It is typically worked in rows (overlay) or rounds (inset).
...
The two main techniques are overlay mosaic crochet (worked in rows, not turned) and inset mosaic crochet (worked into spaces, turned every row). Overlay has more texture; inset is flatter.
...
Mosaic crochet uses only a few basic stitches you already know. Here is the stitch shorthand and what each one does.
...
You only need basic supplies: contrasting yarn colors, a hook, scissors, and a tapestry needle. Stitch markers are optional but helpful.
...
Mosaic crochet charts are read right to left, bottom to top. Each square equals one stitch, and colors show which yarn to use.
...
Here is a written example of an overlay mosaic row. Color A works single crochet across. Color B adds double crochet into stitches two rows below.
