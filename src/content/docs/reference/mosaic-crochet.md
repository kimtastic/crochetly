...
**Answer:** The two main techniques are overlay mosaic crochet (worked in rows, not turned) and inset mosaic crochet (worked into spaces, turned every row). Overlay has more texture; inset is flatter.
...
**Answer:** Mosaic crochet uses only a few basic stitches you already know. Here is the stitch shorthand and what each one does.
...
**Answer:** Mosaic crochet charts are read right to left, bottom to top. Each square equals one stitch, and colors show which yarn to use.
...
**Answer:** Here is a written example of an overlay mosaic row. Color A works single crochet across. Color B adds double crochet into stitches two rows below.
